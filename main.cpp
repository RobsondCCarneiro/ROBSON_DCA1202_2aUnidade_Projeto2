...
int main(){
   ...
   //Criando o programinha para testar os comandos:
    ...
    figuras.push_back(new Brush(' '));
    figuras.push_back(new Retangulo(3, 3, 4, 3));
    figuras.push_back(new Brush('.'));
    figuras.push_back(new Circulo(15, 10, 4, 1));

    //Parte do codigo ignorada por dar errado!
    //entrada.open("C:/Users/robso/Desktop/entrada.txt");
    ...
    saida.open("C:/Users/robso/Desktop/saida.txt");
